...
class User extends \Micro\Model {
    ...
    public function toArray($columns =  NULL) {
        ...
        if (($job = $this->job)) {
            $array['su_sj_name'] = $job->sj_name;
            $array['su_sj_acronym'] = $job->sj_acronym;
        }
    ...
    public function toSimpleArray() {
        ...
        $array = array(
            ...
            'su_sdp_name' => $this->getDepartmentName(),
            ...
            'su_sj_acronym' => $job ? $job->sj_acronym : NULL,
    ...
    public function getDepartmentName() {
        if (($dept = $this->department)) {
            return $dept->sdp_name;
        }
        return NULL;
    }

    public function getCompanyName() {
        if (($comp = $this->company)) {
            return $comp->scp_name;
        }
        return NULL;
    }
    ...
    public static function defaultAvatarThumb() {
        $app = \Micro\App::getDefault();
