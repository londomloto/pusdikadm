...
CREATE TABLE `bpm_links`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 799 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
